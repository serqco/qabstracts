...
\Plot{nonzerofractionbar_xletgroups_totalqualityfractions}{%
    ...
    Only 42\% of abstracts are complete. 
	Less than 30\% of unstructured abstracts and of design article abstracts are complete.
	...
	Less than 5\% of abstracts are proper.
	Here, too, structured abstracts are much better than unstructured ones.
...
being complete, having acceptable Flesh/Kincaide readability,
...
Yet what we find is that only about one in twenty of them indeed are.
...
We find that structured abstracts are significantly more often complete ($\chi^2=260, p < 0.001$)
and significantly more often proper ($\chi^2=17.7, p < 0.001$).
The expectation appears to be very clearly correct.
