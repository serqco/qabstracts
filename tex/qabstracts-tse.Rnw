...
\emph{Results:}
Only \Sexpr{format_percent(r_complete)} of our abstracts are complete, i.e., provide background, objective,
method, result, and conclusion information.
For structured abstracts, the fraction is twice as big.
Only \Sexpr{format_percent(r_readable_good)} of our abstracts also have acceptable Flesh/Kincaide readability and have
...
\Todo{For Lutz: What is question 5?}
...
\begin{enumerate}
	...
	\item We provide data-based how-to instructions for abstracts writing for authors
	  ...
	  need a different and more flexible template than what is used so far.\Todo{For Lutz: Which research question does this apply to? Should this be 4b?}
\end{enumerate}
